...
export default async function SellerLayout({
  ...
  // балансе, который ещё предстоит вывести. Закрывается только работа
  // с товарами.
  const canManageProducts =
    session.user.role === "ADMIN" || !(await isSingleVendorMode())

  return (
    <SellerCapabilitiesProvider value={{ canManageProducts }}>
