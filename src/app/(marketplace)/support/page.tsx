...
const faq = [
  ...
  },
  {
    ...
    a: "Подтверждение платежа от ЮKassa иногда приходит с задержкой до нескольких минут. Если товар не появился в «Моих покупках» через 15 минут, напишите в поддержку и укажите номер заказа.",
  },
  {
  ...
  },
  {
    ...
    a: "Средства холдируются на стороне ЮKassa и перечисляются продавцу после подтверждения сделки. Вывод доступен в разделе «Доходы» панели продавца.",
  },
]
