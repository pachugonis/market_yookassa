    ...
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <div className="space-y-8 text-muted-foreground leading-relaxed">
        <section>
          ...
          <p className="mt-3">
            Данные банковских карт Площадка не получает и не хранит: их обрабатывают
            платёжные сервисы ЮKassa и CloudPayments на своей стороне.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            платёжным сервисам ЮKassa и CloudPayments — для проведения расчётов, почтовому провайдеру —
