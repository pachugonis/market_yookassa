...
export async function POST(request: NextRequest) {
  ...
  // 1. Пора подтверждать: покупатель промолчал, спор не открыт. Сюда же
  // попадают сделки с мгновенным списанием, которое не прошло сразу:
  // у них срок подтверждения наступает в момент заморозки.
